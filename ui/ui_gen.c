...
lv_font_t * font_cn_30;
extern lv_font_t font_cn_30_data;
...
void ui_init_gen(const char * asset_path)
{
    ...
    /* get font 'font_cn_30' from a C array */
    font_cn_30 = &font_cn_30_data;
    ...
    lv_xml_register_font(NULL, "font_cn_30", font_cn_30);
