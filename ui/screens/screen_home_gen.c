...
lv_obj_t * screen_home_create(void)
{
    ...
    lv_obj_t * day_power_row = lv_obj_create(today_card);
    lv_obj_set_name(day_power_row, "day_power_row");
    lv_obj_set_x(day_power_row, 10);
    lv_obj_set_y(day_power_row, 25);
    lv_obj_set_width(day_power_row, 100);
    lv_obj_set_height(day_power_row, 20);
    lv_obj_set_flag(day_power_row, LV_OBJ_FLAG_SCROLLABLE, false);
    lv_obj_set_flex_flow(day_power_row, LV_FLEX_FLOW_ROW);
    lv_obj_set_style_flex_main_place(day_power_row, LV_FLEX_ALIGN_START, 0);
    lv_obj_set_style_flex_cross_place(day_power_row, LV_FLEX_ALIGN_CENTER, 0);
    lv_obj_set_style_bg_opa(day_power_row, 0, 0);
    lv_obj_set_style_border_width(day_power_row, 0, 0);
    lv_obj_set_style_pad_all(day_power_row, 0, 0);
    ...
    lv_obj_set_name(label_day_power_unit, "label_day_power_unit");
    lv_label_set_text(label_day_power_unit, "KW");
    lv_obj_add_style(label_day_power_unit, &style_text_value_xiao, 0);
    ...
    lv_obj_t * month_power_row = lv_obj_create(month_card);
    lv_obj_set_name(month_power_row, "month_power_row");
    lv_obj_set_x(month_power_row, 10);
    lv_obj_set_y(month_power_row, 25);
    lv_obj_set_width(month_power_row, 100);
    lv_obj_set_height(month_power_row, 20);
    lv_obj_set_flag(month_power_row, LV_OBJ_FLAG_SCROLLABLE, false);
    lv_obj_set_flex_flow(month_power_row, LV_FLEX_FLOW_ROW);
    lv_obj_set_style_flex_main_place(month_power_row, LV_FLEX_ALIGN_START, 0);
    lv_obj_set_style_flex_cross_place(month_power_row, LV_FLEX_ALIGN_CENTER, 0);
    lv_obj_set_style_bg_opa(month_power_row, 0, 0);
    lv_obj_set_style_border_width(month_power_row, 0, 0);
    lv_obj_set_style_pad_all(month_power_row, 0, 0);
    ...
    lv_obj_set_name(label_month_power_unit, "label_month_power_unit");
    lv_label_set_text(label_month_power_unit, "KW");
    lv_obj_add_style(label_month_power_unit, &style_text_value_xiao, 0);
