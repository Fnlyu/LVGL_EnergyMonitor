...
lv_obj_t * screen_wt3213_create(void)
{
    ...
    static lv_style_t style_text_flow;
    ...
    if (!style_inited) {
        ...
        lv_style_set_text_color(&style_text_value_small, lv_color_hex(0x4dd4ff));
        lv_style_set_text_font(&style_text_value_small, font_cn_12);
        lv_style_set_text_color(&style_text_flow, lv_color_hex(0xffb020));
        lv_style_set_text_font(&style_text_flow, font_cn_16);
    ...
    if (ui_check_target(UI_TARGET_ALL)) {
        ...
        lv_obj_t * top_bar = top_status_bar_create(lv_obj_0, "电力仪表", "12:30", "WiFi", "●");
        ...
        lv_obj_t * card_power = lv_obj_create(scroll_container);
        lv_obj_set_name(card_power, "card_power");
        lv_obj_set_x(card_power, 0);
        lv_obj_set_y(card_power, 0);
        lv_obj_set_width(card_power, 220);
        lv_obj_set_height(card_power, 60);
        lv_obj_set_flag(card_power, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_add_style(card_power, &style_card, 0);
        lv_obj_add_style(card_power, &style_card_focused, LV_STATE_FOCUSED);
        lv_obj_t * lv_label_0 = lv_label_create(card_power);
        lv_obj_set_x(lv_label_0, 4);
        lv_obj_set_y(lv_label_0, 4);
        lv_label_set_text(lv_label_0, "总功率");
        lv_obj_add_style(lv_label_0, &style_text_title, 0);

        lv_obj_t * label_total_power = lv_label_create(card_power);
        lv_obj_set_name(label_total_power, "label_total_power");
        lv_obj_set_x(label_total_power, 4);
        lv_obj_set_y(label_total_power, 26);
        lv_label_set_text(label_total_power, "3.28");
        lv_obj_add_style(label_total_power, &style_text_big, 0);

        lv_obj_t * lv_label_1 = lv_label_create(card_power);
        lv_obj_set_x(lv_label_1, 80);
        lv_obj_set_y(lv_label_1, 32);
        lv_label_set_text(lv_label_1, "kW");
        lv_obj_add_style(lv_label_1, &style_text_muted, 0);

        lv_obj_t * lv_label_2 = lv_label_create(card_power);
        lv_obj_set_x(lv_label_2, 120);
        lv_obj_set_y(lv_label_2, 28);
        lv_label_set_text(lv_label_2, "● 正常");
        lv_obj_add_style(lv_label_2, &style_text_ok, 0);

        lv_obj_t * card_metrics = lv_obj_create(scroll_container);
        lv_obj_set_name(card_metrics, "card_metrics");
        lv_obj_set_x(card_metrics, 0);
        lv_obj_set_y(card_metrics, 66);
        lv_obj_set_width(card_metrics, 220);
        lv_obj_set_height(card_metrics, 50);
        lv_obj_set_flag(card_metrics, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_add_style(card_metrics, &style_card, 0);
        lv_obj_add_style(card_metrics, &style_card_focused, LV_STATE_FOCUSED);
        lv_obj_t * lv_label_3 = lv_label_create(card_metrics);
        lv_obj_set_x(lv_label_3, 6);
        lv_obj_set_y(lv_label_3, 4);
        lv_label_set_text(lv_label_3, "电压");
        lv_obj_add_style(lv_label_3, &style_text_normal, 0);

        lv_obj_t * label_voltage = lv_label_create(card_metrics);
        lv_obj_set_name(label_voltage, "label_voltage");
        lv_obj_set_x(label_voltage, 6);
        lv_obj_set_y(label_voltage, 22);
        lv_label_set_text(label_voltage, "220.3 V");
        lv_obj_add_style(label_voltage, &style_text_value_small, 0);

        lv_obj_t * lv_label_4 = lv_label_create(card_metrics);
        lv_obj_set_x(lv_label_4, 86);
        lv_obj_set_y(lv_label_4, 4);
        lv_label_set_text(lv_label_4, "电流");
        lv_obj_add_style(lv_label_4, &style_text_normal, 0);

        lv_obj_t * label_current = lv_label_create(card_metrics);
        lv_obj_set_name(label_current, "label_current");
        lv_obj_set_x(label_current, 86);
        lv_obj_set_y(label_current, 22);
        lv_label_set_text(label_current, "12.6 A");
        lv_obj_add_style(label_current, &style_text_value_small, 0);

        lv_obj_t * lv_label_5 = lv_label_create(card_metrics);
        lv_obj_set_x(lv_label_5, 166);
        lv_obj_set_y(lv_label_5, 4);
        lv_label_set_text(lv_label_5, "PF");
        lv_obj_add_style(lv_label_5, &style_text_muted, 0);

        lv_obj_t * label_pf = lv_label_create(card_metrics);
        lv_obj_set_name(label_pf, "label_pf");
        lv_obj_set_x(label_pf, 166);
        lv_obj_set_y(label_pf, 22);
        lv_label_set_text(label_pf, "0.98");
        lv_obj_add_style(label_pf, &style_text_value_small, 0);

        lv_obj_t * card_energy = lv_obj_create(scroll_container);
        lv_obj_set_name(card_energy, "card_energy");
        lv_obj_set_x(card_energy, 0);
        lv_obj_set_y(card_energy, 122);
        lv_obj_set_width(card_energy, 220);
        lv_obj_set_height(card_energy, 50);
        lv_obj_set_flag(card_energy, LV_OBJ_FLAG_SCROLLABLE, false);
        lv_obj_add_style(card_energy, &style_card, 0);
        lv_obj_add_style(card_energy, &style_card_focused, LV_STATE_FOCUSED);
        lv_obj_t * lv_label_6 = lv_label_create(card_energy);
        lv_obj_set_x(lv_label_6, 6);
        lv_obj_set_y(lv_label_6, 4);
        lv_label_set_text(lv_label_6, "累计能耗");
        lv_obj_add_style(lv_label_6, &style_text_normal, 0);

        lv_obj_t * label_energy = lv_label_create(card_energy);
        lv_obj_set_name(label_energy, "label_energy");
        lv_obj_set_x(label_energy, 6);
        lv_obj_set_y(label_energy, 22);
        lv_label_set_text(label_energy, "128.6 kWh");
        lv_obj_add_style(label_energy, &style_text_value, 0);

        lv_obj_t * lv_label_7 = lv_label_create(card_energy);
        lv_obj_set_x(lv_label_7, 120);
        lv_obj_set_y(lv_label_7, 4);
        lv_label_set_text(lv_label_7, "流向");
        lv_obj_add_style(lv_label_7, &style_text_normal, 0);

        lv_obj_t * lv_label_8 = lv_label_create(card_energy);
        lv_obj_set_x(lv_label_8, 120);
        lv_obj_set_y(lv_label_8, 22);
        lv_label_set_text(lv_label_8, "PV to HOME");
        lv_obj_add_style(lv_label_8, &style_text_flow, 0);

        lv_obj_t * bottom_bar = bottom_key_bar_create(lv_obj_0, "上/下 切页", "确认 详情", "8/8");
        ...
        lv_obj_add_play_timeline_event(lv_obj_0, LV_EVENT_SCREEN_LOAD_START, screen_wt3213_get_timeline(lv_obj_0, SCREEN_WT3213_TIMELINE_SCREEN_OPEN), 0, false);
